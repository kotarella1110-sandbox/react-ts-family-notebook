...
const theme = {
  grayBase,
  linkColor,
  grayDarker: lighten(0.135, grayBase),
  grayDark: lighten(0.2, grayBase),
  gray: lighten(0.4, grayBase),
  grayDarkLight: lighten(0.59, grayBase),
  grayLight: lighten(0.7, grayBase),
  grayMoreLight: lighten(0.85, grayBase),
  grayLighter: lighten(0.93, grayBase),
  brandPrimary: '#007f48',
