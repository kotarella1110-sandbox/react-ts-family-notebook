...
const theme = {
  grayBase,
  linkColor,
  grayDarker: lighten(grayBase, '13.5%'),
  grayDark: lighten(grayBase, '20%'),
  gray: lighten(grayBase, '40%'),
  grayDarkLight: lighten(grayBase, '59%'),
  grayLight: lighten(grayBase, '70%'),
  grayMoreLight: lighten(grayBase, '85%'),
  grayLighter: lighten(grayBase, '93%'),
  brandPrimary: '#007f48',
